...
<title>Stream Registration Page</title>
</head>
<body>
<body>
...
<div class="head">
<h1>STREAM REGISTRATION PAGE</h1>
</div>

<div class="container">
   <form:form action="saveStream" method="post" modelAttribute="stream_reg">
  <form:hidden path="streamCourseId"/>
